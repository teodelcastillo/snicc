...
psd3.Pie.prototype.mouseover = function(d) {
    ...
    // esta es la info que puedo mandar por json
    if(typeof(d.data.descripcion) != 'undefined' && d.data.descripcion != null)
    {
        html = "<h2>"+d.data.label+"</h2>"+d.data.descripcion;
        $("#chart_descripcion").hide(); 
        $("#chart_descripcion_inner").html(html).show();
    }


    d3.select("#" + _this.tooltipId)
        .style("left", (d3.event.clientX + window.scrollX - 300) + "px")
        .style("top", (d3.event.clientY + window.scrollY - 100) + "px")
        .select("#value")
...
psd3.Pie.prototype.reDrawPie = function(d, ds) {
    ...
    totalActividades = d.value;
    // console.log('totalActividades:',totalActividades );
